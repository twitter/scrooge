  ...
  "ApacheJavaMetadata" should {
    "generate struct metadata" should {
      ...
      "for list of exceptions field" in {
        ...
        listMetaData.elemMetaData.asInstanceOf[StructMetaData].structClass must be(
          classOf[MyException]
        )
      }
      ...
      "for set of exceptions field" in {
        ...
        setMetaData.elemMetaData.asInstanceOf[StructMetaData].structClass must be(
          classOf[MyException]
        )
      }
      ...
      "for map exception to string field" in {
        ...
        mapMetaData.keyMetaData.asInstanceOf[StructMetaData].structClass must be(
          classOf[MyException]
        )
      ...
      "for map string to exceptions field" in {
        ...
        mapMetaData.valueMetaData.asInstanceOf[StructMetaData].structClass must be(
          classOf[MyException]
        )
      }
    }

...
- (NSString*)description
{
    ...
    [ms appendString:@"_default:"];
    [ms appendFormat:@"%@ ", __default];
...
{
    TFNTwitterThriftGoldRequest *instance = [[TFNTwitterThriftGoldRequest alloc] initWithAList:aList aSet:aSet aMap:aMap subRequests:subRequests _default:_default requiredField:requiredField constructionRequiredField:constructionRequiredField];
    if (error) {
...
- (instancetype)initWithCoder:(NSCoder*)decoder
{
    if (self = [super init]) {
        ...
        if ([decoder containsValueForKey:@"6"]) {
            [self set_Default:(NSString *)[decoder decodeObjectForKey:@"6"]];
        }
...
- (void)encodeWithCoder:(NSCoder*)encoder
{
    ...
    if (__defaultIsSet) {
        [encoder encodeObject:__default forKey:@"6"];
    }
    if (_noCommentIsSet) {
...
- (void)set_Default:(NSString *)_default
{
    __default = [_default copy];
    __defaultIsSet = _default != nil;
}
        ...
        switch (fieldID) {
            ...
            case 6:
                if (fieldType == TType_STRING) {
                    NSString * _default_item;
                    _default_item = [inProtocol readString];
                    [self set_Default:_default_item];
                } else {
                    NSLog(@"%s: field ID %i has unexpected type %i.  Skipping.", __PRETTY_FUNCTION__, fieldID, fieldType);
                    [TProtocolUtil skipType:fieldType onProtocol:inProtocol];
                }
...
- (void)write:(id <TProtocol>)outProtocol
{
    ...
    if (__defaultIsSet) {
        [outProtocol writeFieldBeginWithName:@"_default" type:TType_STRING fieldID:6];
        NSString * _default_item = __default;
        [outProtocol writeString:_default_item];
        [outProtocol writeFieldEnd];
    }
    if (_noCommentIsSet) {
...
- (NSArray *)validateNonOptionalFields
{
    ...
    if (!__defaultIsSet) {
        [invalidFields addObject:@"_default"];
    }
    if (!_requiredFieldIsSet) {

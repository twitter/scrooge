...
public class Xtruct3 implements TBase<Xtruct3, Xtruct3._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("Xtruct3");

  private static final TField STRING_THING_FIELD_DESC = new TField("string_thing", TType.STRING, (short)1);
  private static final TField CHANGED_FIELD_DESC = new TField("changed", TType.I32, (short)4);
  ...
  static {
    ...
    tmpMap.put(_Fields.CHANGED, new FieldMetaData("changed", TFieldRequirementType.DEFAULT, 
    ...
    FieldMetaData.addStructMetaDataMap(Xtruct3.class, metaDataMap);
  }
  ...
  public void unsetChanged() {
    __isset_bit_vector.clear(__CHANGED_ISSET_ID);
  }

  /** Returns true if field changed is set (has been asigned a value) and false otherwise */
  public boolean isSetChanged() {
    return __isset_bit_vector.get(__CHANGED_ISSET_ID);
  }

  public void setChangedIsSet(boolean value) {
    __isset_bit_vector.set(__CHANGED_ISSET_ID, value);
  }
  ...
  public int compareTo(Xtruct3 other) {
    ...
    Xtruct3 typedOther = (Xtruct3)other;
    ...
    lastComparison = Boolean.valueOf(isSetChanged()).compareTo(typedOther.isSetChanged());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChanged()) {
      lastComparison = TBaseHelper.compareTo(this.changed, typedOther.changed);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }

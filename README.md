...
- [scrooge-generator](https://github.com/twitter/scrooge/tree/master/scrooge-generator):
  the code generator
- [scrooge3-runtime](https://github.com/twitter/scrooge/tree/master/scrooge3-runtime):
  some base traits used by the generated code
- [scrooge-maven-plugin](https://github.com/twitter/scrooge/tree/master/scrooge-maven-plugin):
  Plugin for maven to use Scrooge. It comes with an [example project](https://github.com/twitter/scrooge/tree/master/scrooge-maven-plugin/demo)
  showing how to configure your project pom file.
...
Maven users need to add the following to the pom.xml file:
    ...
    <dependency>
      ...
      <artifactId>scrooge3-runtime</artifactId>
...
The plain code generated by Scrooge depends on apache libthrift and scrooge3-runtime.

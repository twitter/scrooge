...
class HandlebarLoader(
  ...
  private val headerTemplate: Option[String] => String = HandlebarLoader.header(commentFct)

  def header(filename: Option[String]): String = headerTemplate(filename)
}
  ...
  def header(
    ...
    { filename: Option[String] =>
      Seq(
        ...
        commentFct(BlockContinuation) + "  source file: %s".format(filename.getOrElse("?")),
        commentFct(BlockEnd)
      ).mkString("\n")
    }
  }

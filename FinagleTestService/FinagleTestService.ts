...
import * as ttypes from './ExampleRequest';
import * as ttypes from './ExampleResponse';
import * as ttypes from './ExampleException';

class FinagleTestServiceWillSucceedArgs {
    public req: ttypes.ExampleRequest;
    ...
    constructor(args?) {
        ...
        if (args) {
            if (args.req !== undefined && args.req !== null) {
                ...
                this.req = new ttypes.ExampleRequest(args.req);
            }
        }
    }
    ...
    public read(input) {
        ...
        while (true) {
            ...
            switch (fid) {
                case 1:
                    if (ftype === Thrift.Type.Ttypes.ExampleRequest) {
                        
                        this.req = new ttypes.ExampleRequest();
                            this.req.read(input);
...
class FinagleTestServiceWillSucceedResult {
    public success: ttypes.ExampleResponse;

    constructor(args?) {
        this.success;
        if (args) {
            if (args.success !== undefined && args.success !== null) {
                this.success = new ttypes.ExampleResponse(args.success);
            }
        }
    }
...
class FinagleTestServiceClient {
    ...
    public willSucceed(req: ttypes.ExampleRequest, callback) {
    ...
    public send_willSucceed(req: ttypes.ExampleRequest, ) {
    ...
    public idlException(req: ttypes.ExampleRequest, callback) {
        this._seqid = this.new_seqid();
        if (callback === undefined) {
            let defer = Q.defer();
            this._reqs[this.seqid()] = function(error, result) {
    ...
    public send_idlException(req: ttypes.ExampleRequest, ) {
        const output = new this.pClass(this.output);
    ...
    public authException(req: ttypes.ExampleRequest, callback) {
        this._seqid = this.new_seqid();
        if (callback === undefined) {
            let defer = Q.defer();
            this._reqs[this.seqid()] = function(error, result) {
    ...
    public send_authException(req: ttypes.ExampleRequest, ) {
        const output = new this.pClass(this.output);
    ...
    public otherException(req: ttypes.ExampleRequest, callback) {
        this._seqid = this.new_seqid();
        if (callback === undefined) {
            let defer = Q.defer();
            this._reqs[this.seqid()] = function(error, result) {
    ...
    public send_otherException(req: ttypes.ExampleRequest, ) {
        const output = new this.pClass(this.output);
